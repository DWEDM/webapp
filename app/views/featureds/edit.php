...
<div class="container mt-5">
  <form action="" method="POST" class="w-50 mx-auto">
    ...
    <div class="mb-2">
      <label for="">Choose Toggle</label>
      <select name="toggle" class="form-control">
        <option value="">Toggle</option>
        <option <?= $row->toggle == 'On' ? 'selected' : '' ?> value="On">On</option>
        <option <?= $row->toggle == 'Off' ? 'selected' : '' ?> value="Off">Off</option>
      </select>
    </div>
