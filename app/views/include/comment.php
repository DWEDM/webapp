          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
              <div class="d-flex flex-row align-items-center">
                <img src="../resources/about/me.jpg" alt="avatar" width="25"
                  height="25" />
                <p class="small mb-0 ms-2">Oblak</p>
              </div>
              <div class="d-flex flex-row align-items-center">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
              <div class="d-flex flex-row align-items-center">
                <img src="../resources/about/me.jpg" alt="avatar" width="25"
                  height="25" />
                <p class="small mb-0 ms-2">Revned</p>
              </div>
              <div class="d-flex flex-row align-items-center">
                <p class="small text-muted mb-0">Upvote?</p>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
              <div class="d-flex flex-row align-items-center">
                <img src="../resources/about/me.jpg" alt="avatar" width="25"
                  height="25" />
                <p class="small mb-0 ms-2">Joblak</p>
              </div>
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
              <div class="d-flex flex-row align-items-center">
                <img src="../resources/about/me.jpg" alt="avatar" width="25"
                  height="25" />
                <p class="small mb-0 ms-2">Miguel</p>
              </div>
              <div class="d-flex flex-row align-items-center">
                <p class="small text-muted mb-0">Upvote?</p>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
